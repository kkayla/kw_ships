...
class BoatsControllerTest < ActionController::TestCase
  ...
  test "should create boat" do
    assert_difference('Boat.count') do
      post :create, boat: { boat_location: @boat.boat_location, max_container: @boat.max_container, name: @boat.name }
    end
  ...
  test "should update boat" do
    patch :update, id: @boat, boat: { boat_location: @boat.boat_location, max_container: @boat.max_container, name: @boat.name }
    assert_redirected_to boat_path(assigns(:boat))
  end
